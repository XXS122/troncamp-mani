...
echo "[kit] Skipping upstream curobo install: kit ships cuRobo 0.8.0 at envs/curobo (installed separately per the setup docs)."

echo "Installation basic environment complete!"
echo -e "Assets (embodiments / objects / textures) are already bundled with this kit — no download needed."
echo -e "Next steps: see the kit README \"快速开始\" (collect -> process_data -> train -> eval_local -> submit)."
